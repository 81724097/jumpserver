...
router.register(r'bulk-change-password', api.BulkChangePasswordViewSet, 'bulk-change-password')
...
urlpatterns = [
    ...
    path('bulk-change-password/<uuid:pk>/run/', api.BulkChangePasswordRunApi.as_view(), name='bulk-change-password-run'),
]
